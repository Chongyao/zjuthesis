...
\begin{center}
    ...
    \begin{tabularx}{.6\textwidth}{>{\fangsong}r >{\fangsong}X<{\centering}}
        ...
        {% For submission
            论文评阅人1： & \uline{\hfill 匿名评审 \hfill} \\
            评阅人2： & \uline{\hfill 匿名评审 \hfill} \\
            评阅人3： & \uline{\hfill 匿名评审 \hfill} \\
            评阅人4： & \uline{\hfill 匿名评审 \hfill} \\
            评阅人5： & \uline{\hfill 匿名评审 \hfill} \\
        }
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{.7\textwidth}{>{\fangsong}r >{\fangsong}X<{\centering}}
        答辩委员会主席： & \uline{\hfill 高曙明 \hfill} \\ 
        委员1： &  \uline{\hfill 高曙明 \hfill} \\
        委员2： &  \uline{\hfill 徐岗 \hfill} \\
        委员3： &  \uline{\hfill 庞宇飞 \hfill} \\
        委员4： &  \uline{\hfill 许威威 \hfill} \\
        委员5： &  \uline{\hfill 蔺宏伟 \hfill} \\
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{.45\textwidth}{>{\fangsong}l >{\fangsong}X<{\centering}}
        答辩日期 & \uline{\hfill 2026年5月17日 \hfill}
    \end{tabularx}
\end{center}
