...
SOURCE_DATA_DIR = os.path.join(PROJECT_ROOT, "source_data", "lady-wrong-partition")
...
def main():
    ...
    print("Plotting Primal Partition...")
    partition_8_path = os.path.join(SOURCE_DATA_DIR, "Partition_8.vtk")
    if os.path.exists(partition_8_path):
        p8_source = load_vtk(partition_8_path, "Partition_8.vtk")
        plot_field(
            renderView1,
            p8_source,
            "partition_0",
        ...
        print("Warning: Partition_8.vtk not found.")

    print("Plotting Dual Partition...")
    partition_9_path = os.path.join(SOURCE_DATA_DIR, "Partition_9.vtk")
    if os.path.exists(partition_9_path):
        p9_source = load_vtk(partition_9_path, "Partition_9.vtk")
        plot_field(
            renderView1,
            p9_source,
            "partition_0",
        ...
        print("Warning: Partition_9.vtk not found.")
