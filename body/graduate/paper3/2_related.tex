...
与区域分解法 (DDM)~\cite{Smith1997DDM} 类似，模态综合法 (CMS) 采用分治策略将计算域划分为多个不重叠的子域。例如，FETI-DP 方法~\cite{Farhat2001FETIDP} 利用拉格朗日乘子（对偶-原始）来强制子域边界上的位移连续性。
