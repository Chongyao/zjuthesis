...
针对前一种情形，上述方法同样适用，这在文献~\cite{chen_multiscale_2021}的开题案例中有所体现。然而，这种全局方法的计算开销非常大。此外，经过多年网格质量优化研究的发展，坏形状单元通常不会遍布整个区域。换言之，这些劣质单元往往是局部的。因此，本研究的目标是针对由畸变单元引起的离散化软硬耦合问题，开发一种轻量且高效的方法，专门处理这一局部的病态问题。
