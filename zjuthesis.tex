...
\documentclass[
    ...
    % Title
    Title           = 物理仿真中软硬耦合问题的基函数重构方法研究,
    TitleEng        = {{Research on Basis Function Reconstruction Methods for Stiff-Soft Coupling Problems in Physical Simulation}}
]{zjuthesis}

%% 论文标题换行
\titletwolines{物理仿真中软硬耦合问题的}{基函数重构方法研究}
