...
\documentclass[
    ...
    % Layout Settings
    TwoSide         = false,            % set to false for no empty pages
    TrueBlankPage   = true,             % 空白页不显示页眉页脚
    % Thesis Info
    ClassNumber     = T391,                        % 按中国图书分类法，学位办网上可查
    Security        = 无,                     % 注明密级与保密期限
    StudentName     = 赵崇遥,
    StudentID       = 11821039,
    AdvisorName     = 黄劲,
    ...
    ShowCVInBlindReview = true,              % 'false'    or 'true'
    ...
    % Title
    % Title           = 面向软硬耦合物理仿真系统的基函数变换解构方法,
    % TitleEng        = {{Research on Basis Function Transformation Deconstruction Methods for Stiff-Soft Coupled Physical Simulation Systems}}
]{zjuthesis}

%% 论文标题换行
\titletwolines{面向软硬耦合物理仿真系统的}{基函数变换解构方法}
% \titleengtwolines{Research on Basis Function Transformation Deconstruction Methods for}{Stiff-Soft Coupled Physical Simulation Systems}
% \titlethreelines{毕业论文题目第一行}{毕业论文题目第二行}{毕业论文题目第三行}
\titleengthreelines{Basis Function Transformation}{for Decoupling Stiff-Soft Coupled}{Physical Simulation Systems}
