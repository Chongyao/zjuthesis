...
}
{
    ...
    % Use Noto CJK fonts on Linux
    \setCJKfamilyfont{zhfs}   {Noto Serif CJK SC} [AutoFakeBold={\FakeBoldSize}]
    \setCJKfamilyfont{zhhei}  {Noto Sans CJK SC}  [AutoFakeBold={\FakeBoldSize}]
    \setCJKfamilyfont{zhkai}  {Noto Serif CJK SC} [AutoFakeBold={\FakeBoldSize}]
    \setCJKfamilyfont{zhsong} {Noto Serif CJK SC} [AutoFakeBold={\FakeBoldSize}]

    \setCJKmainfont[AutoFakeBold={\FakeBoldSize}]{Noto Serif CJK SC}
}
